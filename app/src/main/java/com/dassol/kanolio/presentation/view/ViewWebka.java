...
//
//import pose.dag.totemcoins.R;
//import com.dassol.kanolio.services.Connection;
//
//public class ViewWebka extends AppCompatActivity {
//
//
...
//
//    private static final String TAG = ViewWebka.class.getSimpleName();
//
//    @Override
...
//        setContentView(R.layout.act_starts);
//
//
...
//            ActivityCompat.requestPermissions(ViewWebka.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, loc_perm);
//        }
//
//
...
//                ActivityCompat.requestPermissions(ViewWebka.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE}, file_perm);
//            } else {
...
//            Toast.makeText(ViewWebka.this, share_img, Toast.LENGTH_LONG).show();
...
//                                if (takePictureIntent.resolveActivity(ViewWebka.this.getPackageManager()) != null) {
//                                    File photoFile = null;
//                                    try {
...
//                                if (takeVideoIntent.resolveActivity(ViewWebka.this.getPackageManager()) != null) {
//                                    File videoFile = null;
//                                    try {
...
//            ViewWebka.this.setTaskDescription(taskDesc);
//        }
//
//    }
//
...
//                Log.d(TAG, url);
//
//                Log.d("librarys", Integer.toString(pref.getInt("num", 0)));
//                if (pref.getInt("num", 0) == 3) {
//                    editor.putString("links", url);
//                    editor.putInt("num", -100000);
//                    editor.commit();
//                } else {
//                    editor.putInt("num", pref.getInt("num", 0) + 1);
//                    editor.commit();
//                }
//
//
...
//        if (!ASWP_OFFLINE && !Connection.INSTANCE.isInternetAvailable(ViewWebka.this)) {
...
//            ActivityCompat.requestPermissions(ViewWebka.this, perms, file_perm);
//
...
//            ActivityCompat.requestPermissions(ViewWebka.this, new String[]{Manifest.permission.CAMERA}, file_perm);
//        }
//    }
//
//
